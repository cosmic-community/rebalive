...
import { getArtistBySlug } from '@/lib/cosmic'
...
export default async function ArtistPage({ params }: ArtistPageProps) {
  ...
  const photoUrl = artist.metadata.profile_photo?.imgix_url
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <h1 className="text-4xl font-bold mb-4">{artist.metadata.name}</h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {artist.metadata.twitter && (
                <a
                  href={`https://twitter.com/${artist.metadata.twitter.replace('@', '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {artist.metadata.facebook && (
                <a
                  href={`https://facebook.com/${artist.metadata.facebook}`}
                  target="_blank"
                  rel="noopener noreferrer"
